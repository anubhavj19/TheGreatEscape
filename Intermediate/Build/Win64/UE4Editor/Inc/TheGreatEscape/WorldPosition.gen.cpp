...
#include "TheGreatEscape/WorldPosition.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	THEGREATESCAPE_API UClass* Z_Construct_UClass_UWorldPosition_NoRegister();
	THEGREATESCAPE_API UClass* Z_Construct_UClass_UWorldPosition();
	ENGINE_API UClass* Z_Construct_UClass_UActorComponent();
	UPackage* Z_Construct_UPackage__Script_TheGreatEscape();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_UWorldPosition_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_TheGreatEscape,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UWorldPosition, 618370374);
	template<> THEGREATESCAPE_API UClass* StaticClass<UWorldPosition>()
	{
		return UWorldPosition::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UWorldPosition(Z_Construct_UClass_UWorldPosition, &UWorldPosition::StaticClass, TEXT("/Script/TheGreatEscape"), TEXT("UWorldPosition"), false, nullptr, nullptr, nullptr);
