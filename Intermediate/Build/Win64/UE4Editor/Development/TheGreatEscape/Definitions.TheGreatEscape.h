#undef THEGREATESCAPE_API
#undef THEGREATESCAPE_VTABLE
...
#define UE_PROJECT_NAME TheGreatEscape
...
#define THEGREATESCAPE_VTABLE DLLEXPORT_VTABLE
#define THEGREATESCAPE_API DLLEXPORT
